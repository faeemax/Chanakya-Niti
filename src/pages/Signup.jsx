    ...
    <div className="min-h-screen bg-royal-bg flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-white mb-2">Establish Legacy</h1>
          <p className="text-royal-muted font-medium">Begin your journey to absolute power.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card-royal space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-xs font-black text-royal-muted uppercase tracking-widest ml-1">Desired Username</label>
        ...
        <p className="text-center mt-8 text-royal-muted text-sm font-medium">
          Already have a legacy? <span onClick={() => navigate('/login')} className="text-royal-primary font-bold cursor-pointer hover:underline">Continue Command</span>
        </p>
      </motion.div>
    </div>
  );
